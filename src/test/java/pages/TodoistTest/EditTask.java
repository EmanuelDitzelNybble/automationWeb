...
public class EditTask {
        ...
        public Button editDueDateWeekend = new Button(By.xpath("//div[normalize-space()='This weekend']"), "[Due Date] button in edit task");
        public Button editPriority = new Button(By.xpath("//div[@aria-label=\"Priority\"]//span"), "[Edit] priority button in edit task");
        public Button choosingHighPriority = new Button(By.xpath("//li[@id=\"dropdown-select-12-option-4\"]"), "[Priority] button in edit task");
